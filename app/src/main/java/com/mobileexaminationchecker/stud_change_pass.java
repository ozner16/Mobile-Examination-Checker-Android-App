...
public class stud_change_pass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stud_change_pass);
                ...
                user.updatePassword(new_pass)
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(stud_change_pass.this, stud_home.class));
                                finish();
                            }
                            else {
